(() => {
    ...
    document.querySelectorAll(".products-image").forEach((n => {
...
***************************************************************************** */
    ...
    const steps = document.querySelectorAll(".quiz__question");
    if (steps) steps.forEach((step => {
        const buttonPrevSteps = document.querySelectorAll(".quiz__arrow-prev");
        const buttonNextSteps = document.querySelectorAll(".quiz__arrow-next");
        let index = 0;
        show(steps[index]);
        buttonNextSteps.forEach((buttonNextStep => {
            buttonNextStep.addEventListener("click", (function() {
                hide(steps[index]);
                index++;
                if (!steps[index]) steps.forEach((step => {
                    document.addEventListener("click", (function(e) {
